        ...
        <div class="row d-flex align-items-center">
            <div class="col-lg-6 d-none d-lg-block">
                <figure class="single-image wow fadeInLeft">
                    <img src="{{ asset(optional($experience)->image) }}" alt="">
                </figure>
            </div>
            <div class="col-lg-6">
                <div class="experience-text">
                    <h3 class="title wow fadeInUp" data-wow-delay="0.3s">{{ optional($experience)->title }}</h3>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="icon-info wow fadeInUp" data-wow-delay="0.3s">
                                ...
                                <h6><a href="javascript:void(0)" class="text">{{ optional($experience)->phone }}</a>
                                </h6>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="icon-info wow fadeInUp" data-wow-delay="0.4s">
                                ...
                                <h6><a href="javascript:void(0)" class="text">{{ optional($experience)->email }}</a>
                                </h6>
                            </div>
                        </div>
                    </div>
