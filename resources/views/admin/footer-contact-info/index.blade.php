...
@section('content')
    <section class="section">
        <div class="section-header">
            ...
            <h1>Informações de contato do rodapé</h1>
        </div>
                            ...
                            <form action="{{ route('admin.footer-contact-info.update', 1) }}" method="post"
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <input type="text" name="address" value="{{ $contactFooter->address }}"
                                            class="form-control">
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <input type="text" name="phone" value="{{ $contactFooter->phone }}"
                                            class="form-control">
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <input type="text" name="email" value="{{ $contactFooter->email }}"
                                            class="form-control">
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
