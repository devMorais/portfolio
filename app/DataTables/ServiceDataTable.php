...
class ServiceDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($query) {
                return '<a href="' . route('admin.service.edit', $query->id) . '" class="btn btn-primary btn-small"><i class="fas fa-edit"></i></a>
                        <a href="' . route('admin.service.destroy', $query->id) . '" class="delete-item btn btn-danger btn-small"><i class="fas fa-trash"></i></a>';
            })
            ->setRowId('id');
    }
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('name')->width(200)->addClass('text-center')->title('Nome'),
